	...
	return (
		<div className="ui container">
			<Router>
				...
				{
				// We don't use this as this will create new component everytime
				/* <Switch>
					<Route path="/" exact component={() => (<ContactList contacts={contacts} removeContactHandler= {removeContactHandler} />)} />
